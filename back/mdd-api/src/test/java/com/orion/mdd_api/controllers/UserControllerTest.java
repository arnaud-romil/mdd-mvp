...
class UserControllerTest {
    ...
    void shouldAllowUserToSubscribeToTopic() throws Exception {
        ...
        mockMvc.perform(post("/users/me/topics/2"))
        ...
        .andExpect(jsonPath("$.topics[0].description").value("Spring is a powerful, feature-rich framework for building Java applications."));
    }
    ...
    void shouldAllowUserToUnsubscribeToTopic() throws Exception {
        ...
        mockMvc.perform(delete("/users/me/topics/1"))
        .andExpect(status().isOk())
